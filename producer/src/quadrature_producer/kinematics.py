...
def build_model(a_value, x0_value, v0_value, ground: float = 0.0) -> Model:
    ...
    identities = [
        ("v_formula_is_integral",
         r"The algebra formula $v = v_0 + at$ is the integral $\int a\,dt$ with $v(0)=v_0$.",
         v_alg - v_expr),
        ("x_formula_is_integral",
         r"The algebra formula $x = x_0 + v_0 t + \tfrac12 a t^2$ is the integral $\int v\,dt$ with $x(0)=x_0$.",
         x_alg - x_expr),
        ("apex_is_v_zero",
         r"Velocity is zero at the apex time $t_{\text{apex}}$ — so the apex time is correct.",
        ...
        ("flight_time_lands",
         "At the flight time the calculus trajectory returns to the ground — so the flight time is correct.",
